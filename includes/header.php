...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link <?= $activePage === 'admin' ? 'active' : '' ?>" href="admin.php" data-title="Admin">
                <i class="fas fa-user-shield"></i> <span>Admin</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= $activePage === 'user' ? 'active' : '' ?>" href="user.php" data-title="User Management">
                <i class="fas fa-users"></i> <span>User Management</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= $activePage === 'deduction' ? 'active' : '' ?>" href="deduction.php" data-title="Setup">
                <i class="fas fa-calculator"></i> <span>Settings</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= $activePage === 'allowances' ? 'active' : '' ?>" href="monthly.php" data-title="Allowance Management">
                <i class="fas fa-money-bill-wave"></i> <span>Monthly Allowance</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= $activePage === 'report' ? 'active' : '' ?>" href="report.php" data-title="Report Management">
