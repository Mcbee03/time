...
>>>>>>> 02fe2482d41500ea0a254c4dcf41f272cd9686ee
        ...
        <li class="nav-item"><a class="nav-link <?= $activePage === 'user' ? 'active' : '' ?>" href="userManagement.php" data-title="User Management"><i class="fas fa-users"></i> <span>User Management</span></a></li>
        ...
        <li class="nav-item"><a class="nav-link <?= $activePage === 'allowances' ? 'active' : '' ?>" href="monthlyManagement.php" data-title="Allowance Management"><i class="fas fa-user-shield"></i> <span>Monthly Allowance</span>
