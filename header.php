...
<nav class="navbar navbar-expand-lg navbar-custom fixed-top">
    <button id="sidebarToggle" class="btn btn-link text-dark mr-3"><i class="fas fa-bars"></i></button>
    <a class="navbar-brand text-dark" href="#" id="navTitle">NOVADECI Medical</a>
